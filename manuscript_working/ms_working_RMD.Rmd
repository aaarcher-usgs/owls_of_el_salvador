...
*Table 1XX. Species detection records by route. Owl surveys were conducted from 2003 to 2013 in three different protected areas within El Salvador, although specific survey years varied by route (Year range in table).*
...
![2XX. Probability of occupancy ($\psi_{t,h}$) by route $h$ and year $t$ for Mottled Owl. Owl surveys were conducted from 2003 to 2013 in three different protected areas within El Salvador. Posteriors were summarized with median $\pm$ 90% credible intervals. \label{figure2}](../output/figures/mottd_psi_byYr-1.png)



![3XX. Probability of occupancy ($\psi_{t,h}$) by route $h$ and year $t$ for FerPy Owl. Owl surveys were conducted from 2003 to 2013 in three different protected areas within El Salvador. Posteriors were summarized with median $\pm$ 90% credible intervals. \label{figure3}](../output/figures/ferpy_psi_byYr-1.png)

![4XX. Probability of occupancy ($\psi_{t,h}$) by route $h$ and year $t$ for Spectacled Owl. Owl surveys were conducted from 2003 to 2013 in three different protected areas within El Salvador. Posteriors were summarized with median $\pm$ 90% credible intervals. \label{figure4}](../output/figures/specd_psi_byYr-1.png)
